...
function ServiceCardV2({ service }: { service: Service }) {
  ...
  return (
    <div className="w-full bg-white hover:scale-[1.03] transition-all duration-300 ease-in-out overflow-hidden group rounded-md hover:shadow-md border border-gray ">
      <div
        key={service.name}
      ...
      <div className="w-full h-fill relative">
        ...
        <div className="p-5 pt-10 flex flex-col h-full gap-2 justify-between">
          <h1 className="font-text xl:text-lg 2xl:text-xl font-bold text-green transition-all leading-tight duration-300 ease-in-out">
            {service.name}
          </h1>
